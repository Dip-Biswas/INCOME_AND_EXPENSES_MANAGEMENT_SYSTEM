...
?>
   <?php
        ...
        $date = $item = $price =  $expense_bud_added = "";
        ...
        if( empty($_POST["expense_date"]) ){
            $dateErr = "<P style='color:red'>* Please Add a Date </p>";
       }else {
              ...
              if( empty($_POST["expense_price"]) ){
               ...
               $price = trim($_POST["expense_price"]);
                ...
                if ( !empty($date) && !empty($item) && !empty($price) ){
                        ...
                        $add_expense = "INSERT INTO budget( date , item , price , email ) VALUES ( '$date','$item','$price','$email' )" ;
                        $result = mysqli_query($conn , $add_expense);
                        $date = $item = $price = "";

                        $expense_bud_added = " <div class='alert alert-warning alert-dismissible fade show'>
                        Budget added  !
